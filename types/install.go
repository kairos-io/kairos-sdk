...
type Install struct {
	...
	Bundles                Bundles             `yaml:"bundles,omitempty" mapstructure:"bundles" json:"bundles,omitempty"`
	...
	Partitions             ElementalPartitions `yaml:"partitions,omitempty" mapstructure:"partitions" json:"partitions,omitempty"`
	Active                 Image               `yaml:"system,omitempty" mapstructure:"system" json:"system,omitempty"`
	Recovery               Image               `yaml:"recovery-system,omitempty" mapstructure:"recovery-system" json:"recovery-system,omitempty"`
	Passive                Image               `yaml:"passive,omitempty" mapstructure:"recovery-system" json:"passive,omitempty"`
	GrubDefEntry           string              `yaml:"grub-entry-name,omitempty" mapstructure:"grub-entry-name" json:"grub-entry-name,omitempty"`
	ExtraPartitions        PartitionList       `yaml:"extra-partitions,omitempty" mapstructure:"extra-partitions" json:"extra-partitions,omitempty"`
