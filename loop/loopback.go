...
func Loop(img string, rw bool, log types.KairosLogger) (loopDevice string, err error) {
	...
	log.Logger.Debug().Str("image", img).Msg("Opening img file")
...
func Unloop(loopDevice string, log types.KairosLogger) error {
	log.Logger.Debug().Str("device", loopDevice).Msg("Opening loop device")
